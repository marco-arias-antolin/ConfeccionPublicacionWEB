                ...
                <table class="table">
                    ...
                    <tbody>
                        <?php
                            ...
                            $param = $cnx->prepare("SELECT nif, apellidos, nombre, DATE_FORMAT(fechaNacimiento,'%d-%m-%Y') as 'fecha' FROM personas WHERE fechaNacimiento between ? AND ? ORDER BY apellidos, nombre");
                            ...
                            $param->bind_param("ss",$filtro1,$filtro2);
                            //Ejecutamos//
                            $param->execute();
