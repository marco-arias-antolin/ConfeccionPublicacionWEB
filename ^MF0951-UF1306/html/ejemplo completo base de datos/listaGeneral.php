                ...
                <table class="table">
                    ...
                    <tbody>
                        <?php
                            ...
                            switch ($filtro) {
                                case '0':
                                    $SQL = "SELECT nif, apellidos, nombre, DATE_FORMAT(fechaNacimiento,'%d-%m-%Y') as 'fecha' FROM personas ORDER BY apellidos, nombre";
                                    break;
                                case '1':
                                    $SQL = "SELECT nif, apellidos, nombre, DATE_FORMAT(fechaNacimiento,'%d-%m-%Y') as 'fecha' FROM personas ORDER BY apellidos, nombre LIMIT 5";
                                    break;
                                case '2':
                                    $SQL = "SELECT nif, apellidos, nombre, DATE_FORMAT(fechaNacimiento,'%d-%m-%Y') as 'fecha' FROM personas ORDER BY apellidos, nombre LIMIT 20";
                                    break;
                                case '3':
                                    $SQL = "SELECT nif, apellidos, nombre, DATE_FORMAT(fechaNacimiento,'%d-%m-%Y') as 'fecha' FROM personas ORDER BY apellidos, nombre LIMIT 50";
                                    break; 
                                case '4':
                                    $SQL = "SELECT nif, apellidos, nombre, DATE_FORMAT(fechaNacimiento,'%d-%m-%Y') as 'fecha' FROM personas ORDER BY apellidos, nombre LIMIT 100";
                                    break;    
                                default:
