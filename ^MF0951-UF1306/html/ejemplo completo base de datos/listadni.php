    ...
    <body>
        ...
        <nav aria-label="breadcrumb" class="container-fluid bg-light">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Buscar NIF</li>
            </ol>
        </nav>
        <?php    
              if (!isset($_POST['filtro'])) {
                ...
                <section class="container w-75 mt-2 bg-secondary p-3">
                    <form name="form1" id="form1" method="post" action="listadni.php">
                        <label class="form-label text-white">Introduzca NIF/NIE a buscar</label>
                        <input type="text" required maxlength="10" class="form-control w-25" placeholder="Teclear apellidos o patrón de búsqueda" name="filtro" id="filtro">
                ...
                <table class="table">
                    ...
                    <tbody>
                        <?php
                            ...
                            $param = $cnx->prepare("SELECT nif, apellidos, nombre, DATE_FORMAT(fechaNacimiento,'%d-%m-%Y') as 'fecha' FROM personas WHERE nif like ? ORDER BY apellidos, nombre");
                            ...
                            if ($data->num_rows == 0) {
                                echo "Ese NIF/NIE no está en la Base de Datos<br>";
                                echo "<a href='listadni.php' class='btn btn-secondary'>Volver</a>";
                            }
                            else {
                    ...
                    <tfoot>
                        <tr>
                            <td colspan="6" class="text-center">
                                <a href="listadni.php" class="btn btn-secondary">Volver</a>
                            </td>
                        </tr>
                    </tfoot>
                </table>
